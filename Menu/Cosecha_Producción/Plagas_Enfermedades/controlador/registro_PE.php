...
if (!empty($_POST["btnregistrar"])) { 
    if (!empty($_POST["identificador_de_la_siembra"]) and !empty($_POST["Fecha"]) and !empty($_POST["Tipo_de_plaga_o_enfermedad"]) and !empty($_POST["Cantidad_de_plantas_afectadas"]) and !empty($_POST["Grado_de_afectacion"]) and !empty($_POST["Tratamiento"]) and !empty($_POST["Resultados_de_los_tratamientos"]) and !empty($_POST["Observaciones"]) ) { 
        ...
        $sql=$conexion_PE->query(" INSERT INTO plagas_y_enfermedades(identificador_de_la_siembra,Fecha,Tipo_de_plaga_o_enfermedad,Cantidad_de_plantas_afectadas,Grado_de_afectacion,Tratamiento,Resultados_de_los_tratamientos,Observaciones) VALUES ('$identificador_de_la_siembra','$Fecha','$Tipo_de_plaga_o_enfermedad','$Cantidad_de_plantas_afectadas','$Grado_de_afectacion','$Tratamiento','$Resultados_de_los_tratamientos','$Observaciones')"); 
