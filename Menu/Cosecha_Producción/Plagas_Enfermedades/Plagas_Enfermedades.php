...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="Plagas_Enfermedades.css">
</head>
<body>
...
<!-- ----------------------------------------------------------------------------------------------------------- -->
  ...
  <header class="header">
        ...
        <a href="../Cosecha_Produccion.php">Atras</a>
...
<table class="table">
  ...
  <?php
    ...
    <tr>
      ...
      <td>
      <a href="modificar_PE.php?id=<?= $datos->identificador_de_la_siembra?>" class="btn btn-small"><i class="fa-solid fa-pen-to-square"></i></a>
      </td>
