...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="Registro_Jornaleros.css">
</head>
<body>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $datos->Genero ?></td>
      <td>
        <a href="modificar_RJ.php?id=<?= $datos->Nombre_completo ?>" class="btn btn-small"><i class="fa-solid fa-pen-to-square"></i></a>
      </td>
    </tr>
