...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      <a href="modificar_EA.php?id=<?= $datos->Tipo_de_emergencia ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
      <a href="Emergencias_Ambientales.php?id=<?= $datos->Tipo_de_emergencia ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash-can"></i></a>
      </td>
