...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="Control_Seguimiento.css">
</head>
<body>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      <a href="modificar_CS.php?id=<?= $datos->identificador_de_siembra ?>" class="btn btn-small"><i class="fa-solid fa-pen-to-square"></i></a>
      </td>
